                ...
                <div className = "" style = {{ border: "none", borderBottom: "solid 1px gray" }}>
                    <div className = "row" style = {{ maxWidth: "100%" }}>
                        <div className="toggleContainer">
                            <h3><label className = "col-3" htmlFor="switch1" style = {{ color: checked === '1' ? "gray" : "skyblue", fontStyle: "bold", paddingLeft: "3vw" }}>메아리</label></h3>
                            <div className="trainingToggle" style = {{ border: "solid 1px pink" }}>
                                <input value = { checked } id="switch1" className="switch col-3 offset-6" type="checkbox" onClick = { checkedSwitch } style = {{ }} />
                                <label htmlFor = "switch1" style = {{ marginLeft: "85vw" }}></label>
                                <table className = "col-12" style = {{ width: "100%" }}>
                                    <tbody style = {{ width: "100%" }}>
                                        <tr className="workout" style = {{ marginLeft: "20px" }}>
                                            <td style = {{ width: "100%" }}>
                                                <div className = "row">
